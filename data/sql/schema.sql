...
CREATE TABLE term (id BIGINT AUTO_INCREMENT, word VARCHAR(100) NOT NULL, authorname VARCHAR(100) NOT NULL, authoremail VARCHAR(255) NOT NULL, definition TEXT NOT NULL, example TEXT, likes BIGINT DEFAULT 0 NOT NULL, verified TINYINT DEFAULT 0 NOT NULL, approved TINYINT DEFAULT 0 NOT NULL, created_at DATETIME, updated_at DATETIME, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = INNODB;
